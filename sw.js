const CACHE = "movie-imprint-shell-v83";
...
const SHELL = [
  ...
  "/styles/app.css?v=72",
  "/src/app.js?v=78",
  "/src/share-card.js?v=1",
  "/src/ticket.js?v=7",
  "/src/ticket-normalize.js?v=2",
  "/src/event-types.js?v=4",
  "/src/event-types.js",
  "/src/format-badge.js",
  "/src/ticket-ocr.js?v=2",
  ...
  "/src/db.js?v=16",
  "/src/tmdb.js?v=3",
  "/src/external-publications.js?v=1",
  "/src/domain.js?v=21",
  "/src/export.js?v=5",
  "/src/self-interview.js?v=1",
  "/src/imprint-v2.js?v=1",
  "/src/bangumi.js?v=14",
  "/src/work-search.js?v=6",
  "/src/tags.js?v=1",
  "/src/tag-i18n.js?v=1"
];
