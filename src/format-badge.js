...
const FORMAT_RULES = [
  { key: "imax-gt", label: "IMAX GT", tone: "imax", patterns: [/IMAX\s*(?:(?:レーザー|LASER|with\s*Laser)\s*)?GT/i] },
  ...
  { key: "4d", label: "4D", tone: "warm", patterns: [/^4D$/i, /4DX/i, /MX4D/i] },
  { key: "screenx", label: "ScreenX", tone: "screenx", patterns: [/ScreenX/i] },
  { key: "normal", label: "普通", tone: "neutral", patterns: [/^普通$/, /^2D$/i] },
  { key: "other", label: "其他", tone: "neutral", patterns: [/^其他$/] }
];

/** 视觉权重更高的制式——影院卡的增强描边/高光只为这些制式启用 */
export const HIGH_SPEC_FORMAT_KEYS = ["imax", "imax-gt", "dolby", "4d", "screenx"];
